...
<head>
    ...
    <script src="{{ asset('js/flash-alert.js') }}" defer></script>
    <!-- Fonts -->
                        ...
                        @if(session('login'))
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{ route('applogout') }}"
                                       onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();">
                                        {{ __('Logout') }}
                                    </a>

                                    <form id="logout-form" action="{{ route('applogout') }}" method="POST" class="d-none">
                                        @csrf
                                    </form>
                                </div>
                            </li>
